...
3. The speed of all electromagnetic (EM) waves in empty space is 3.00 × 10⁸ m/s. Calculate the wavelength of EM waves emitted at the following frequencies:  
   a) Radio waves; 88.0 MHz  
   b) Visible light; 6.0 × 10⁸ MHz  
   c) X rays; 3.0 × 10¹² MHz  
...
5. Given a tuning fork's sound frequency of 256 Hz and a wavelength in air of 1.35 m,   
   ...
   b) What would be the wavelength of this same sound in water, in which sound travels 1 500 m/s?  

6. Microwaves travel at the speed of light. When the frequency of the microwaves is 9.00 × 10³ MHz, what is their wavelength?  
...
9. A string is rigidly attached to a post at one end. Several pulses of amplitude 0.15 m sent down the string are reflected at the post and travel back down the string without a loss of amplitude.  
   a) What is the amplitude at a point on the string where the maximum displacements of two pulses cross? What kind of interference is this?  
   b) How would the answers change if the same pulses were sent down a string whose end is free?
