...
The energy stored in a capacitor can be calculated as $PE_{e} = \frac{1}{2} C V^2$, where $C$ is the capacitance and $V$ is the voltage. The energy density (energy per unit volume) in the electric field is $PE_{e} = \frac{1}{2} \epsilon_0 E^2$.
