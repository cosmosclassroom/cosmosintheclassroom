...
**Note:** The "b" sections for problems 7 and 8 are identical to the "b" section in problem 6. This is because the prompt asked for the same calculation in each case. If you want different calculations for "b", please let me know.