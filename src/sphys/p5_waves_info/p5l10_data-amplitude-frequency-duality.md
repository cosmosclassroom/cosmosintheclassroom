...
> Use the data contained in this document to add evidence to your experimental summary table:

<div class='template-table'>

||High Amplitude EM <br> (brighter)|Low Amplitude EM <br> (dimmer)|
|-:|-|-|-|
|Infrared Light (low frequency)|<br><br><br><br>||
|Visible Light (middle frequency)|<br><br><br><br>||
|UV Light (high frequency)|<br><br><br><br>||
|X-Ray (highest frequency)|<br><br><br><br>||
...
## Data - Light exposure to living cells
...
## Data - Light exposure to electronic device (solar panel)
...
-->
  1. For both the low and high amplitude UV and X-ray exposures, what happens to the damage level when **amplitude** increases? Now compare this to what happens when **frequency** increases (e.g., from UV to X-ray). Which factor appears to have a stronger influence on cell damage?
<!--
...
-->
  1. In Table 2, analyze the relationship between light amplitude and electric current produced in the photovoltaic panel. For each frequency level that produces electrons, what happens to the current when **amplitude** increases? 
<!--
