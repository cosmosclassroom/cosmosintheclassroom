...
> 1. Tape a strip of paper horizontally (landscape) across the width of your screen such that the car is visible above the paper. 
> 2. Run the video, pausing at important events and marking on the paper the location of the car at each important position.
> 3. Label each mark with the mathematical symbol determined above ($x_0$, etc.)
...
> 4. Copy the table below into your science notebook
...
| Variable measured:  | Measured on Screen<br> (in meters) | Actual Value (in meters) |
| ----: | :----: | :----: |
| Length of car  |  | 4.5 meters |
...
# Checkpoint 2
- Will the calculated distances (reaction and braking) be different if the driver is distracted? How? Why?

</div>

#### Collecting Data on the Distracted Driver

>1.  Repeat your data collection for the distracted driver. Either use a new strip of paper or write on the back of the first, but be sure to indicate which is which.
> 2. Calculate the reaction and braking distances for the distracted driver.

<div class='checkpoint'>

# Checkpoint 3
- How well did the predictions match the data?
- In what way(s) were they different?

</div>

## Analyzing Motion with Time
...
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSf8ZGsIlEVB0n5T9O9v5-4mgH7P9Kd8QTXFdk77Sx3VFxNEjg/viewform?embedded=true" width="640" height="590" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>