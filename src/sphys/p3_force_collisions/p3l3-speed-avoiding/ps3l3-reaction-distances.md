...
Plot **reaction distance vs. speed** for both distracted and not-distracted drivers.  
Use different colors or symbols to differentiate between the two lines. Use a ruler to ensure your graph is to scale. 


## Analysis Questions

1.  What do the data you generated show about how speed affects reaction distance?
2.  How (if at all) would being distracted affect this relationship?
