...
Produce two waves similar to the “before” diagram above and run the simulation. Run the simulation and complete the diagrams in Table 2 above.
...
3. In your lab notebook, draw what you see happening with the matter after the interaction.

4. After the waves meet at the same place in space, how does the total energy compare with the total energy before?
...
Label this set of interaction diagrams “Interaction C”
Before
During
After
