...
# Waves
How can energy transfer through space?
...
* **Holt's Example:** Consider a ripple on a pond (transverse) versus a sound wave (longitudinal).
...
* **Wavelength (λ):** The distance between two corresponding points on consecutive waves. (Holt: From crest to crest, or trough to trough.)
* *Example:* X-ray crystallographers work with wavelengths around 0.1 nanometers (1 Angstrom) to study molecular structures.

* **Period (T):** The time it takes for one complete wave to pass a given point. (Holt: The time for one oscillation.)

* **Frequency (f):** The number of waves passing a point per unit time. (Holt: Related to the period: f = 1/T)
...
* **Holt's Example:** Sound waves from two speakers can create areas of louder and quieter sound due to interference.
...
* **Holt's Application:** Used in radar to determine the speed of vehicles.

---

## Summary (Aligned with Holt Physics)

* Waves can be transverse or longitudinal.
* Amplitude, wavelength, period, and frequency describe wave characteristics.
* Superposition leads to constructive and destructive interference.
* Diffraction explains wave bending.
* The Doppler Effect alters perceived frequency.

---

## Practice Problems

### Problem 1: Sound Wave Analysis
* A sonar device emits a sound wave that returns after 1.5 seconds.
* **Conceptual:** Explain why the wave's frequency remains constant but its amplitude decreases.
* **Calculation:** If the speed of sound in water is 1500 m/s, how far is the detected object?
* (Hint: Remember the wave travels to and from the object)

---

### Problem 2: Light Wave Diffraction
* Light passes through a double slit with spacing d = 0.2 mm.
* **Conceptual:** Why do we see bright and dark bands instead of just two bright lines?
* **Calculation:** If the wavelength is 500 nm and the first bright fringe appears at an angle of 0.15°, verify if the slit spacing matches using: d sin θ = mλ (where m = 1)

---

### Problem 3: Doppler Effect
* An ambulance with siren frequency 400 Hz approaches at 30 m/s.
