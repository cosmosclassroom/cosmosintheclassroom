---
Layout: Default
Title: PS 8.1 - Harmonics of Springs and Pendula
...
6. A 0.75 kg mass is attached to a vertical spring and stretches the spring 30.0 cm. It is then placed on a horizontal surface and set oscillating. What is the period of the vibration?  
7. A 2.0 kg mass on a spring oscillates with an amplitude of 15 cm. If the spring constant is 200 N/m, calculate:
...
10. Two identical waves traveling in opposite directions have wavelength 2.0 m and amplitude 3.0 cm. What is:
    1. The distance between adjacent nodes in the resulting standing wave
    2. The maximum amplitude that can occur
