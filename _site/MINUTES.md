...
- Deployed new Google Apps Script event logger (Version 2) for universal analytics:
   ...
   - Access: Anyone
   - Usage: POST (JSON) preferred, GET fallback; Apps Script must handle CORS and JSON parsing.
   - Example implementation documented in README.md and universal-data-logger.js

### August 22, 2025

- Deployed new Google Apps Script event logger for universal analytics:
   - Endpoint: https://script.google.com/macros/s/AKfycbxUC9gSE3LANxjl3zzP1nXNxrhmQvVYxWgqQn7cAnzAZ4-_OBg6kgpIBhZEZh8ZQak6/exec
   - Deployment ID: AKfycbxUC9gSE3LANxjl3zzP1nXNxrhmQvVYxWgqQn7cAnzAZ4-_OBg6kgpIBhZEZh8ZQak6
   - Access: Anyone
   - Usage: POST (JSON) preferred, GET fallback; Apps Script must handle CORS and JSON parsing.
   - Example implementation documented in README.md and universal-data-logger.js
