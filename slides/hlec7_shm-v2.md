...
![left](img/9_waves-optics/8_waves_5.png)
...
$$ E = \frac{1}{2}m \cdot \vec{v}^2 = \frac{1}{2}k\cdot x^2 $$

This is partly explained by the **conservation of mechanical energy**, which is generally at work in simple harmonic motion
