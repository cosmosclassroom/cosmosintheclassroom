...
|----------|---------|:-------:|-------------|
| **Fundamentals** | Current | $I = \frac{Q}{t}$ | A (Amperes) |
| | Electric Potential | $V = \frac{PE}{q}$ | V (Volts) |
| **Ohm's Law** | Basic Form | $V = I \cdot R$ | V = A × Ω |
| | Resistance Form | $R = \frac{V}{I}$ | Ω (Ohms) |
| **Power** | Voltage-Current | $P = V \cdot I$ | W (Watts) |
| | Current-Resistance | $P = I^2 \cdot R$ | W = A² × Ω |
| | Voltage-Resistance | $P = \frac{V^2}{R}$ | W = V² ÷ Ω |
| **Circuit Analysis** | Series Resistance | $R_{eq} = R_1 + R_2 + \dots$ | Total increases |
| | Parallel Resistance | $\frac{1}{R_{eq}} = \frac{1}{R_1} + \frac{1}{R_2} + \dots$ | Total decreases |
